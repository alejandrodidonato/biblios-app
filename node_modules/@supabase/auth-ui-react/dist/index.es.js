import { css as D, createStitches as r1, createTheme as s1 } from "@stitches/core";
import { generateClassNames as I, VIEWS as L, template as c1, merge as W, en as i1, PREPENDED_CLASS_NAMES as a1 } from "@supabase/auth-ui-shared";
import e, { useState as d, useRef as m1, useEffect as R, createContext as u1, useContext as d1 } from "react";
const g1 = D({
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    {
      ...v,
      style: (C = r == null ? void 0 : r.style) == null ? void 0 : C.button,
      className: E.join(" "),
      disabled: o
    },
    n,
...
function X({
  ...
  var _;
  const [E, C] = d(""), [w, u] = d(""), [a, m] = d(""), [c, y] = d(!1), x = async (h) => {
    var s;
    h.preventDefault(), u(""), m(""), y(!0);
    const { error: g } = await l.auth.signInWithOtp({
      email: E,
      options: { emailRedirectTo: r }
    });
    g ? u(g.message) : m((s = n == null ? void 0 : n.magic_link) == null ? void 0 : s.confirmation_text), y(!1);
  }, i = n == null ? void 0 : n.magic_link;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: x }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: o }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "email", appearance: o }, i == null ? void 0 : i.email_input_label), /* @__PURE__ */ e.createElement(
    B,
    {
      id: "email",
      name: "email",
    ...
    V,
    {
      href: "#auth-sign-in",
      onClick: (h) => {
        h.preventDefault(), t(L.SIGN_IN);
      },
      appearance: o
    },
    (_ = n == null ? void 0 : n.sign_in) == null ? void 0 : _.link_text
  ), a && /* @__PURE__ */ e.createElement(S, { appearance: o }, a), w && /* @__PURE__ */ e.createElement(S, { color: "danger", appearance: o }, w)));
}
const b = D({
  width: "21px",
  height: "21px"
}), _1 = ({ provider: t }) => t == "google" ? y1() : t == "facebook" ? L1() : t == "twitter" ? b1() : t == "apple" ? p1() : t == "github" ? M1() : t == "gitlab" ? k1() : t == "bitbucket" ? S1() : t == "discord" ? N1() : t == "azure" ? F1() : t == "keycloak" ? z1() : t == "linkedin" ? D1() : t == "notion" ? $1() : t == "slack" ? B1() : t == "spotify" ? H1() : t == "twitch" ? P1() : t == "workos" ? V1() : null, y1 = () => /* @__PURE__ */ e.createElement(
  "svg",
  {
    className: b(),
...
function I1({
  ...
  const [a, m] = d(!1), [c, y] = d(""), x = l === "vertical", i = C === "magic_link" ? "sign_in" : C, _ = async (g) => {
    m(!0);
    const { error: s } = await t.auth.signInWithOAuth({
      provider: g,
      options: {
        redirectTo: v,
        scopes: n == null ? void 0 : n[g],
        queryParams: o
      }
    });
    s && y(s.message), m(!1);
  ...
  return /* @__PURE__ */ e.createElement(e.Fragment, null, r && r.length > 0 && /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: u }, /* @__PURE__ */ e.createElement(
    z,
    {
    ...
    r.map((g) => {
      ...
      return /* @__PURE__ */ e.createElement(
        ...
        x && c1(
          (s = w == null ? void 0 : w[i]) == null ? void 0 : s.social_provider_text,
          {
            provider: h(g)
          }
        )
  ...
  )), !E && /* @__PURE__ */ e.createElement(C1, { appearance: u })));
}
function Q({
  authView: t = "sign_in",
  defaultEmail: l = "",
  ...
  var T, G, Z, j;
  const x = m1(!0), [i, _] = d(l), [h, g] = d(r), [s, N] = d(""), [p, $] = d(!1), [P, U] = d("");
  R(() => (x.current = !0, _(l), g(r), () => {
    x.current = !1;
  }), [t]);
  const O = async (M) => {
    var q;
    switch (M.preventDefault(), N(""), $(!0), t) {
      case "sign_in":
      ...
      case "sign_up":
        ...
        J ? N(J.message) : o1 && !n1 && U((q = m == null ? void 0 : m.sign_up) == null ? void 0 : q.confirmation_text);
        break;
    }
    x.current && $(!1);
  }, F = (M) => {
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    ), C && /* @__PURE__ */ e.createElement(z, { direction: "vertical", gap: "small", appearance: c }, t === L.SIGN_IN && a && /* @__PURE__ */ e.createElement(
      V,
      {
        href: "#auth-magic-link",
        onClick: (M) => {
          M.preventDefault(), n(L.MAGIC_LINK);
        },
        appearance: c
      },
      (T = m == null ? void 0 : m.magic_link) == null ? void 0 : T.link_text
    ), t === L.SIGN_IN && /* @__PURE__ */ e.createElement(
      V,
      {
        href: "#auth-forgot-password",
        onClick: (M) => {
          M.preventDefault(), n(L.FORGOTTEN_PASSWORD);
        },
        appearance: c
      },
...
function e1({
  ...
  const [E, C] = d(""), [w, u] = d(""), [a, m] = d(""), [c, y] = d(!1), x = async (h) => {
    ...
    g ? u(g.message) : m((s = n == null ? void 0 : n.forgotten_password) == null ? void 0 : s.confirmation_text), y(!1);
  }, i = n == null ? void 0 : n.forgotten_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-forgot-password", onSubmit: x }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: o }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "email", appearance: o }, i == null ? void 0 : i.email_label), /* @__PURE__ */ e.createElement(
    B,
    {
      id: "email",
      name: "email",
...
function t1({
  ...
  const [n, o] = d(""), [v, E] = d(""), [C, w] = d(""), [u, a] = d(!1), m = async (y) => {
    var i;
    y.preventDefault(), E(""), w(""), a(!0);
    const { error: x } = await t.auth.updateUser({ password: n });
    x ? E(x.message) : w((i = l == null ? void 0 : l.update_password) == null ? void 0 : i.confirmation_text), a(!1);
  }, c = l == null ? void 0 : l.update_password;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-update-password", onSubmit: m }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: r }, /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "password", appearance: r }, c == null ? void 0 : c.password_label), /* @__PURE__ */ e.createElement(
    B,
    {
      id: "password",
      name: "password",
    ...
    u ? c == null ? void 0 : c.loading_button_label : c == null ? void 0 : c.button_label
  ), C && /* @__PURE__ */ e.createElement(S, { appearance: r }, C), v && /* @__PURE__ */ e.createElement(S, { color: "danger", appearance: r }, v)));
}
function A1({
  setAuthView: t = () => {
  },
  ...
  var N;
  const [E, C] = d(""), [w, u] = d(""), [a, m] = d(""), [c, y] = d(""), [x, i] = d(""), [_, h] = d(!1), g = async (p) => {
    ...
    P && y(P.message), h(!1);
  }, s = n == null ? void 0 : n.verify_otp;
  return /* @__PURE__ */ e.createElement("form", { id: "auth-magic-link", onSubmit: g }, /* @__PURE__ */ e.createElement(z, { gap: "large", direction: "vertical", appearance: o }, ["sms", "phone_change"].includes(r) ? /* @__PURE__ */ e.createElement("div", null, /* @__PURE__ */ e.createElement(H, { htmlFor: "phone", appearance: o }, s == null ? void 0 : s.phone_input_label), /* @__PURE__ */ e.createElement(
    B,
    {
      id: "phone",
      name: "phone",
    ...
    V,
    {
      href: "#auth-sign-in",
      onClick: (p) => {
        p.preventDefault(), t(L.SIGN_IN);
      },
      appearance: o
    },
    (N = n == null ? void 0 : n.sign_in) == null ? void 0 : N.link_text
  ), x && /* @__PURE__ */ e.createElement(S, { appearance: o }, x), c && /* @__PURE__ */ e.createElement(S, { color: "danger", appearance: o }, c)));
}
const l1 = u1({ user: null, session: null }), U1 = (t) => {
  const { supabaseClient: l } = t, [r, n] = d(null), [o, v] = d((r == null ? void 0 : r.user) ?? null);
  R(() => {
    (async () => {
      var u;
      const { data: w } = await l.auth.getSession();
      n(w.session), v(((u = w.session) == null ? void 0 : u.user) ?? null);
    })();
    const { data: C } = l.auth.onAuthStateChange(
      async (w, u) => {
        n(u), v((u == null ? void 0 : u.user) ?? null);
      }
    );
    return () => {
...
function k({
  ...
  const _ = W(i1, c.variables ?? {}), [h, g] = d(v), [s, N] = d(""), [p, $] = d(""), P = h === "sign_in" || h === "sign_up" || h === "magic_link";
  R(() => {
    var F, f;
    r1({
      theme: W(
